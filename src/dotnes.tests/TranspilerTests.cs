...
public class TranspilerTests
{
    ...
    [InlineData("hello", true)]
    [InlineData("hello", false)]
    [InlineData("onelocal", true,       Skip = "Not working since implementing branching")]
    [InlineData("onelocal", false,      Skip = "Not working since implementing branching")]
    [InlineData("onelocalbyte", true,   Skip = "Not working since implementing branching")]
    [InlineData("onelocalbyte", false,  Skip = "Not working since implementing branching")]
